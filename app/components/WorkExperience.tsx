import { Title, Text, Stack, Box, Group, Badge, Card } from '@mantine/core';
    ...
    <Stack gap="xl" mb="xl" pb="xl" style={{ borderBottom: '1px solid var(--mantine-color-gray-3)' }}>
      ...
      <Stack gap="lg">
        {workHistory.map((exp) => (
          ...
          >
            <Stack gap="sm">
              <Title order={3} size="h3" fw={700}>{exp.title}</Title>
              ...
              {exp.achievements.length > 0 && (
                <>
                  <Text size="sm" fw={600} mt="xs">Key Achievements:</Text>
