...
export const workHistory: WorkExperience[] = [
  {
    ...
    description:
      'Enhanced legacy client-facing applications and architected new platforms to reduce technical debt and accelerate feature development.',
  ...
  },
  {
    ...
    description:
      'Developed and delivered full-stack web applications for government clients, specializing in wargaming simulation software and mission-critical tools.',
  ...
  },
  {
    ...
    description:
      'Provided technical support across campus technology systems and developed internal .NET web applications to address university requirements.',
